...
const Cloth = () => {
  ...
  <img src="../ass/images/cloth90.png" alt="Your Image" class="responsive-image"/>
</div>
...
<RelatedSlider category="Cloth Hanger" />
<div class="a21"><center>Cloth Hanger<hr/>
</center></div><br></br><br></br>
<RelatedProduct category="Cloth Hanger" />  
            </section>
        </main>
    );
};
