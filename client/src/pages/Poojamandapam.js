...
const Poojamandapam = () => {
    ...
    return (
      ...
      <hr/>
      <center>
      <h1 class="heading"><font color="#1b4106">Poojamandapam </font></h1></center>
      <hr/>
    ...
    <RelatedSlider category="pooja" />
    <div class="a21"><center>Poojamandapam<hr/>
    </center></div><br></br><br></br>
    <RelatedProduct category="pooja" />  
    </section>
     </main>
     );
     };

export default Poojamandapam;