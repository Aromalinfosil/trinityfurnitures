...
const Tsofas = () => {
    ...
    return (
      ...
      <hr/>
      <center>
      <h1 class="heading"><font color="#1b4106">Telephone Sofa </font></h1></center>
      <hr/>
...
<RelatedSlider category="TelephoneSofa" />
<div class="a21"><center>Telephone Sofa<hr/>
</center></div><br></br><br></br>
<RelatedProduct category="TelephoneSofa" />  
            </section>
        </main>
    );
};

export default Tsofas;