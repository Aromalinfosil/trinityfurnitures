...
const Chairs = () => {
  ...
  <img src="../ass/images/chairs.png" alt="Your Image" class="responsive-image"/>
</div>
    ...
    <RelatedSlider category="Chairs" />
    <div class="a21"><center> Chair<hr/>
    </center></div><br></br><br></br>
    <RelatedProduct category="Chairs" />  
    </section>
    </main>
    );
    };
