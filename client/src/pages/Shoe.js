...
const Shoe = () => {
  ...
  <img src="../ass/images/shoer.png" alt="Your Image" class="responsive-image"/>
</div>
    ...
    <div class="a21"><center>New Arrivals...
     ...
     <RelatedSlider category="Shoe Rack" />
     <div class="a21"><center> Shoe Rack<hr/>
     </center></div><br></br><br></br>
     <RelatedProduct category="Shoe Rack" />  
      </section>
      </main>
    );
};
