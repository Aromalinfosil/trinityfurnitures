...
const Poojamandapam1 = () => {
    
    const featuredProducts = productsData.filter(item => item.tag === 'poojamandapam');
        ...
        >
            {
                featuredProducts.map((item) => {
                    ...
                    <div class='modelm'>
                    <h4 className=""style={{ fontSize: '20px',fontFamily:'Poppins, sans-serif' }}><font color="#09470b">Item: {title}</font></h4>
