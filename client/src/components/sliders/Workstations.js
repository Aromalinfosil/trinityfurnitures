...
const Workstations = () => {
    ...
    const featuredProducts = productsData.filter(item => item.tag === 'workstation');
        ...
        >
            {
                featuredProducts.map((item) => {
                    const { id, images, title, finalPrice, originalPrice,tagline, path, model,dimension,dimension1, info } = item;
                  ...
                  <h3 className=""style={{ fontSize: '18px',fontFamily:'Poppins, sans-serif' }}>Dimension</h3>
                    <h3 className=""style={{ fontSize: '15px',fontFamily:'Poppins, sans-serif' }}>{dimension}</h3>
                    <h3 className=""style={{ fontSize: '15px',fontFamily:'Poppins, sans-serif' }}>{dimension1}</h3>
</div> {/* <h5 className="product-new-top">{info}</h5>	 */}
