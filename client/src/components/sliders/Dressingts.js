...
const Dressingts = () => {
    ...
    const featuredProducts = productsData.filter(item => item.tag === 'dressingtabl');
    ...
    return (
        ...
        <div class='modelm'>
        <h4 className=""style={{ fontSize: '23px',fontFamily:'Poppins, sans-serif' }}><font color="#09470b">Item: {title}</font></h4>
